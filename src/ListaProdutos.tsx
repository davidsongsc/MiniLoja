...
const ListaProdutos: React.FC = () => {
  ...
  const products = [
    ...
    { id: 4, name: 'Camisa Branca', status: 'Esgotado', imagem: 'https://img.elo7.com.br/product/original/17B1547/camisa-sublimacao-poliester.jpg' },
    { id: 5, name: 'Camisa Preta', status: 'Esgotado', imagem: 'https://i5.walmartimages.com/asr/0325ebe6-484d-400f-870b-b4bf1536aa3b.156a51f72a8534c3758b16fb9982cafa.jpeg' },
    { id: 6, name: 'Camisa Manga', status: 'Esgotado', imagem: 'https://a-static.mlcdn.com.br/800x560/camisa-manga-longa-masculina/matsonvazmodas/aed58c62cfc911ec815b4201ac18506b/4b72919ef8f3ae669a90bc2f64529863.jpg' },
